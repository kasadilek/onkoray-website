# Astro Skeleton Starter — Coding Guidelines

This document contains coding guidelines and conventions for the Astro Skeleton Starter — a CMS-agnostic Astro template focused on Performance, SEO, A11y, and GSAP animations.
